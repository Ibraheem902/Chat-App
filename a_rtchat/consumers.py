...
class ChatroomConsumer(WebsocketConsumer):
    def connect(self):
        ...
        # add and update online users in the chatroom
    ...
    def disconnect(self, close_code):
        ...
        # remove and update online users in the chatroom
    ...
    def online_count_handler(self, event):
        ...
        author_id = set([message.author.id for message in chat_messages])
        users = User.objects.filter(id__in=author_id)
...
class OnlineStatusConsumer(WebsocketConsumer):
    ...
    def online_status_handler(self, event):
        ...
        puplic_chat_users = ChatGroup.objects.get(group_name='public-chat').users_online.exclude(id=self.user.id)
        ...
        if puplic_chat_users or private_chats_with_users or group_chats_with_users:
            online_in_chat = True
        else:
        ...
        context = {
            ...
            'online_in_chat': online_in_chat,
            'public_chat_users': puplic_chat_users,
            'user': self.user
        }
